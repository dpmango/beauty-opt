  ...
  APP.Components.Header = {
    init: function() {
      ...
      $(document).on('click', '.btn-open-full-catalog', function() {
        ...
        $('.menu-full-catalog').toggleClass('menu-full-catalog_hidden');
        return false;
      });
      ...
      $(document).on('click', '.menu-full-catalog__head .btn-back', function() {
        ...
        $('.menu-full-catalog__main_current').removeClass('menu-full-catalog__main_active');

        // удаляем текущую метку
        $('.menu-full-catalog__main_current').removeClass('menu-full-catalog__main_current');
        ...
        $('.menu-full-catalog__main_previous').addClass('menu-full-catalog__main_current');

        // удаляем метку предыдущего меню у текущего меню
        $('.menu-full-catalog__main_current').removeClass('menu-full-catalog__main_previous');
        ...
        if ($('.menu-full-catalog__main_current').hasClass('menu-full-catalog__main')) {
          ...
          // скрыть кнопку назад
          $(this).addClass('menu-full-catalog__hidden');
